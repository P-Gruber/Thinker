package org.thinker.thinker.infrastructure.dataretrieving
...
import org.thinker.thinker.infrastructure.dataretrieving.datasources.FileContent

class AndroidDataRetriever(private val context: Context) : DataRetriever
{
    override fun retrieveData(dataSourceName: DataSourceName): Either<Exception, String>
    {
